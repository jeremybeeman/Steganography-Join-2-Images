...
bits_used_by_front = 7#put the number of bits your front image will contain (your back image will have 8-bits_used_by_front bits)
...
startTime = time.time()
print("encoding...")
imgEncoded = b_join.simple_pixelwise_1X1_encode(front_image_path, back_image_path, bits_used_by_front)
...
startTime = time.time()
print("decoding...")
imgsDecoded = b_join.simple_pixelwise_1X1_decode(joined_image_path, bits_used_by_front)
